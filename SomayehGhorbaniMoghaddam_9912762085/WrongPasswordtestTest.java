...
public class WrongPasswordtestTest {
  ...
  public void wrongPasswordtest() {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector("*[data-test=\"submitButton\"]"));
    ...
    driver.findElement(By.cssSelector("*[data-test=\"regPasswordField\"]")).sendKeys("test4321");
    driver.findElement(By.cssSelector(".btn-fade")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".btn-fade"));
      Actions builder = new Actions(driver);
    ...
    driver.findElement(By.cssSelector("*[data-test=\"forgotPasswordLink\"]")).click();
  }
}
